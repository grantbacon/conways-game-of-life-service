...
(check-expect (build-next-generation-cell 3 3 0 0 (input-lines->avl-tree 0 0 3 (list (coerce "x  " 'list)
                                                                                                          (coerce "x  " 'list)
                                                                                                          (coerce "x  " 'list)
                                                                                                          )
                                                                                              (empty-tree))
...
(check-expect (build-next-generation-row 4 4 0 0 (input-lines->avl-tree 0 0 4 (list (coerce "x xx" 'list)
                                                                                                          (coerce "xxxx" 'list)
                                                                                                          (coerce "x  x" 'list)
                                                                                                          (coerce "   x" 'list))
                                                                                              (empty-tree))
                                                               (empty-tree)) 
              nil)
(check-expect (build-next-generation-row 4 4 1 1 (input-lines->avl-tree 0 0 4 (list (coerce "x   " 'list)
                                                                                                          (coerce "x   " 'list)
                                                                                                          (coerce "x   " 'list)
                                                                                                          (coerce "    " 'list))
                                                                                              (empty-tree))
                                                               (empty-tree))
               (list 2 5 "x" (list 1 4 "x" nil nil) nil))
(check-expect (build-next-generation-row 1 1 0 0 (empty-tree) (empty-tree)) nil)
(check-expect (build-next-generation-row 4 4 1 1 (input-lines->avl-tree 0 0 4 (list (coerce "xx  " 'list)
                                                                                                          (coerce "x   " 'list)
                                                                                                          (coerce "x   " 'list)
                                                                                                          (coerce "    " 'list))
                                                                                              (empty-tree))
...
(check-expect (build-next-generation 4 4 0 (input-lines->avl-tree 0 0 4 (list (coerce " x  " 'list)
                                                                                              (coerce "xx  " 'list)
                                                                                              (coerce "    " 'list)
                                                                                              (coerce "    " 'list))
                                                                                              (empty-tree))
                                                               (empty-tree))
               (list 2 1 "x" (list 1 0 "x" nil nil) nil))
(check-expect (build-next-generation 4 4 0 (input-lines->avl-tree 0 0 4 (list (coerce " xx " 'list)
                                                                                              (coerce "xx  " 'list)
                                                                                              (coerce "x   " 'list)
                                                                                              (coerce " x  " 'list))
                                                                                              (empty-tree))
...
(check-expect (build-next-generation 4 4 0 (input-lines->avl-tree 0 0 4 (list (coerce " xx " 'list)
                                                                                              ...
                                                                                              (empty-tree))
                                                               (empty-tree))
               (list 2 2 "x" (list 1 0 "x" nil nil) (list 1 3 "x" nil nil)))
